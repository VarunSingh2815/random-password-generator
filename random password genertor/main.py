...
root.config(bg='#E0EEEE')# size of the window by default

# title of our window
root.title("Random Password Generator by Varun Singh")
...
pass_head = Label(root, text='Password Length', font='arial 12 bold',bg='#E0EEEE').pack(pady=10)  # to generate label heading

pass_len = IntVar()  # integer variable to store the input of length of the password wanted
length = Spinbox(root, from_=4, to_=32, textvariable=pass_len, width=24,bg='#FFF8DC', font='arial 16').pack()
...
pass_label = Label(root, text='Random Generated Password', font='arial 12 bold',bg='#E0EEEE').pack(pady="30 10")
Entry(root, textvariable=output_pass, width=24, font='arial 16',bg='#FFF8DC').pack()
